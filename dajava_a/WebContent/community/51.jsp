...
<div id="wrap">
<h1>공지사항 등록</h1>
<form name="frm" id="frm" action="<%=request.getContextPath()%>/community/writeAction.do" method="post">
<b class="c1">제목</b>	&nbsp;&nbsp; 	&nbsp;&nbsp; 
<table >
	<tr>
		<th class="c3"><input type="text"  style="width:940px; height:50px; outline:block;" class="c2" name="Ntitle" id="title" value=""></th>
...
<table>
	<tr>
		<td><textarea rows="25" cols="131" name="Ncontents" id="ir1"></textarea></td>
	</tr>
</table>
