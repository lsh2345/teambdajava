...
<% 
String Qidx = (String)request.getAttribute("Qidx"); 
String QoriginQidx = (String)request.getAttribute("QoriginQidx"); 
String Qdepth = (String)request.getAttribute("Qdepth"); 
...
<body>
<h1 class="Q1">Q&A 답변</h1>
<form name="frm" id="frm" action="<%=request.getContextPath()%>/community/reAction1.do" method="post">
<input type="hidden" name="Qidx" value="<%=Qidx%>">
<input type="hidden" name="QoriginQidx" value="<%=QoriginQidx%>">
...
<table >
	<tr>
		<th class="c3"><input type="text" style="width:940px; height:50px;" class="c2" name="Qtitle"></th>
	</tr>
</table>
<b class="c1">본문</b>	&nbsp;&nbsp; 	&nbsp;&nbsp; 
<table>
...
<b class="c0">게시글 비밀번호</b><input type="password" style="width:200px; height:30px;"  name="Qpassword" >
<button style="width:100pt; height:25pt; margin-left:320px;" id="save">등록</button>
<button style="width:100pt; height:25pt;">초기화</button>
</div>
