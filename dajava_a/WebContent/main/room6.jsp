	...
	<meta charset="UTF-8">
		...
		<script>
			...
			$(function(){
			 ...
			 function changePic(idx) {
				...
				switch(num){
				case 1:
					$(".header").css({"background":"url(<%=request.getContextPath()%>/filefolder/r6.jpg)"});
					$(".header").css({"background-size":"cover"});
					break;
				case 2:
					$(".header").css({"background":"url(<%=request.getContextPath()%>/filefolder/r6-living.jpg)"});
					$(".header").css({"background-size":"cover"});
					break;
				case 3:
		...
		<style>
			.header {
			  width: 100%;
			  height: 100vh;
			  background:url('<%=request.getContextPath()%>/filefolder/r6.jpg');
