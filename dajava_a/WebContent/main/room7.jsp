	...
	<meta charset="UTF-8">
			...
			$(function(){
			 ...
			 function changePic(idx) {
				...
				case 1:
					...
					break;
				case 2:
					$(".header").css({"background":"url(<%=request.getContextPath()%>/filefolder/r7-living.jpg)"});
					$(".header").css({"background-size":"cover"});
					break;
				case 3:
					$(".header").css({"background":"url(<%=request.getContextPath()%>/filefolder/r6-r7-bath.jpg)"});
					$(".header").css({"background-size":"cover"});
					break;
				}				
		...
		<style>
			.header {
			  width: 100%;
			  height: 100vh;
			  background:url('<%=request.getContextPath()%>/filefolder/r7-r8.jpg');
